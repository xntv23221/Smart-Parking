...
public class AdminInterceptor implements HandlerInterceptor {
    ...
    public AdminInterceptor(JwtService jwtService, ObjectMapper objectMapper) {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (!UserRole.ADMIN.name().equals(role) && !UserRole.MANAGER.name().equals(role)) {
        ...
        UserContextHolder.set(new UserContext(userId, UserRole.valueOf(role)));
        return true;
    }
